...
## Возможные проблемы
* У меня, начиная с третьего задания, после добавления Docker, данные отправленные из Postman - визуально(может и не визуально, а действительно не доходят) не отображались в бд Postgresql.
